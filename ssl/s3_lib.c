...
# endif
    ...
    {
     1,
     NTLS_TXT_RSA_WITH_SM4_SM3,
     NULL,
     NTLS_CK_RSA_WITH_SM4_SM3,
     SSL_kRSA,
     SSL_aRSA,
     SSL_SM4,
     SSL_SM3,
    ...
    {
     1,
     NTLS_TXT_RSA_WITH_SM4_SHA1,
     NULL,
     NTLS_CK_RSA_WITH_SM4_SHA1,
     SSL_kRSA,
     SSL_aRSA,
     SSL_SM4,
     SSL_SHA1,
...
# ifndef OPENSSL_NO_OPTIMIZE_CHACHA
    int use_chacha = 0;
# endif
#endif
