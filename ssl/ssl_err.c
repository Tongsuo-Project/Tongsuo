...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_CERTIFICATE_FILE_NTLS, 0),
     "ssl_use_certificate_file_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_ENC_CERTIFICATE, 0),
     "SSL_use_enc_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_ENC_PRIVATEKEY, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_PRIVATEKEY_FILE_NTLS, 0),
     "ssl_use_PrivateKey_file_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_SIGN_CERTIFICATE, 0),
     "SSL_use_sign_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_SIGN_PRIVATEKEY, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CHOOSE_SIGALG_NTLS, 0),
