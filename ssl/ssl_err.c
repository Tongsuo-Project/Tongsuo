...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CONSTRUCT_CA_NAMES_NTLS, 0),
     "construct_ca_names_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CONSTRUCT_KEY_EXCHANGE_TBS, 0),
     "construct_key_exchange_tbs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CONSTRUCT_KEY_EXCHANGE_TBS_NTLS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CUSTOM_EXT_ADD_NTLS, 0),
     "custom_ext_add_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CUSTOM_EXT_PARSE, 0), "custom_ext_parse"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CUSTOM_EXT_PARSE_NTLS, 0),
     "custom_ext_parse_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DC_SIGN, 0), "DC_sign"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS1_READ_FAILED_NTLS, 0),
     "dtls1_read_failed_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS1_RETRANSMIT_MESSAGE, 0),
     "dtls1_retransmit_message"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS1_RETRANSMIT_MESSAGE_NTLS, 0),
     "dtls1_retransmit_message_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS_CONSTRUCT_CHANGE_CIPHER_SPEC_NTLS, 0),
     "dtls_construct_change_cipher_spec_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS_CONSTRUCT_HELLO_VERIFY_REQUEST, 0),
     "dtls_construct_hello_verify_request"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS_CONSTRUCT_HELLO_VERIFY_REQUEST_NTLS, 0),
     "dtls_construct_hello_verify_request_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS_PROCESS_HELLO_VERIFY_NTLS, 0),
     "dtls_process_hello_verify_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS_WAIT_FOR_DRY_NTLS, 0),
     "dtls_wait_for_dry_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CERT_VERIFY, 0),
     "ntls_construct_cert_verify"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CERT_VERIFY_NTLS, 0),
     "ntls_construct_cert_verify_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CKE_RSA, 0),
     "ntls_construct_cke_rsa"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CKE_SM2, 0),
     "ntls_construct_cke_sm2"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CKE_SM2DHE, 0),
     "ntls_construct_cke_sm2dhe"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CLIENT_CERTIFICATE, 0),
     "ntls_construct_client_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CLIENT_CERTIFICATE_NTLS, 0),
     "ntls_construct_client_certificate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CLIENT_KEY_EXCHANGE, 0),
     "ntls_construct_client_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_CLIENT_KEY_EXCHANGE_NTLS, 0),
     "ntls_construct_client_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_SERVER_CERTIFICATE_NTLS, 0),
     "ntls_construct_server_certificate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_SERVER_KEY_EXCHANGE, 0),
     "ntls_construct_server_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_SERVER_KEY_EXCHANGE_NTLS, 0),
     "ntls_construct_server_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_SKE_RSA, 0),
     "ntls_construct_ske_rsa"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_SKE_SM2, 0),
     "ntls_construct_ske_sm2"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_CONSTRUCT_SKE_SM2DHE, 0),
     "ntls_construct_ske_sm2dhe"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_OUTPUT_CERT_CHAIN, 0),
     "ntls_output_cert_chain"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_OUTPUT_CERT_CHAIN_NTLS, 0),
     "ntls_output_cert_chain_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CERT_VERIFY, 0),
     "ntls_process_cert_verify"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CERT_VERIFY_NTLS, 0),
     "ntls_process_cert_verify_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CKE_RSA, 0),
     "ntls_process_cke_rsa"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CKE_SM2, 0),
     "ntls_process_cke_sm2"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CKE_SM2DHE, 0),
     "ntls_process_cke_sm2dhe"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CLIENT_KEY_EXCHANGE, 0),
     "ntls_process_client_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CLIENT_KEY_EXCHANGE_NTLS, 0),
     "ntls_process_client_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_CV_SM2DHE, 0),
     "ntls_process_cv_sm2dhe"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_SERVER_KEY_EXCHANGE, 0),
     "ntls_process_server_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_SERVER_KEY_EXCHANGE_NTLS, 0),
     "ntls_process_server_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_SKE_RSA, 0),
     "ntls_process_ske_rsa"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_SKE_SM2, 0),
     "ntls_process_ske_sm2"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_PROCESS_SKE_SM2DHE, 0),
     "ntls_process_ske_sm2dhe"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_SM2_DERIVE, 0), "ntls_sm2_derive"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NTLS_SM2_DERIVE_NTLS, 0),
     "ntls_sm2_derive_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT13_WRITE_TRAN_NTLSSITION, 0),
     "ossl_statem_client13_WRITE_TRAN_NTLSsition"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_CONSTRUCT_MESSAGE, 0), ""},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_CONSTRUCT_MESSAGE_NTLS, 0),
     "ossl_statem_client_construct_message_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_POST_PROCESS_MESSAGE, 0),
     "ossl_statem_client_post_process_message"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_POST_PROCESS_MESSAGE_NTLS, 0),
     "ossl_statem_client_post_process_message_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_PROCESS_MESSAGE, 0),
     "ossl_statem_client_process_message"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_PROCESS_MESSAGE_NTLS, 0),
     "ossl_statem_client_process_message_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_READ_TRANSITION, 0),
     "ossl_statem_client_read_transition"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_READ_TRANSITION_NTLS, 0),
     "ossl_statem_client_read_transition_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_WRITE_TRANSITION, 0),
     "ossl_statem_client_write_transition"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_WRITE_TRANSITION_NTLS, 0),
     "ossl_statem_client_write_transition_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_WRITE_TRAN_NTLSSITION_NTLS, 0),
     "ossl_statem_client_WRITE_TRAN_NTLSsition_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_CONSTRUCT_MESSAGE_NTLS, 0),
     "ossl_statem_server_construct_message_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_POST_PROCESS_MESSAGE, 0),
     "ossl_statem_server_post_process_message"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_POST_PROCESS_MESSAGE_NTLS, 0),
     "ossl_statem_server_post_process_message_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_POST_WORK, 0),
     "ossl_statem_server_post_work"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_POST_WORK_NTLS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_PROCESS_MESSAGE_NTLS, 0),
     "ossl_statem_server_process_message_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_READ_TRANSITION, 0),
     "ossl_statem_server_read_transition"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_READ_TRANSITION_NTLS, 0),
     "ossl_statem_server_read_transition_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_WRITE_TRANSITION, 0),
     "ossl_statem_server_write_transition"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_WRITE_TRANSITION_NTLS, 0),
     "ossl_statem_server_write_transition_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PARSE_CA_NAMES, 0), "parse_ca_names"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PARSE_CA_NAMES_NTLS, 0),
     "parse_ca_names_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_READ_STATE_MACHINE_NTLS, 0),
     "read_state_machine_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_CHECK_CERT_AND_ALGORITHM_NTLS, 0),
     "ssl3_check_cert_and_algorithm_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_OUTPUT_CERT_CHAIN_NTLS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_ADD_CERT_TO_WPACKET_NTLS, 0),
     "ssl_add_cert_to_wpacket_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_ADD_COMPRESSION_ALG, 0),
     "ssl_cert_add_compression_alg"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CHOOSE_CLIENT_VERSION_NTLS, 0),
     "ssl_choose_client_version_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CONNECTION_IS_NTLS, 0),
     "SSL_connection_is_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CREATE_CIPHER_LIST, 0),
     "ssl_create_cipher_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTRL, 0), "SSL_ctrl"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_ADD_CERT_COMPRESSION_ALG, 0),
     "SSL_CTX_add_cert_compression_alg"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_CHECK_PRIVATE_KEY, 0),
     "SSL_CTX_check_private_key"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_DUP, 0), "SSL_CTX_dup"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_DC, 0), "SSL_CTX_use_dc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_DC_FILE, 0),
     "SSL_CTX_use_dc_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_DC_PRIVATEKEY, 0),
     "SSL_CTX_use_dc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_DC_PRIVATEKEY_FILE, 0),
     "SSL_CTX_use_dc_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_ENC_CERTIFICATE, 0),
     "SSL_CTX_use_enc_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_ENC_CERTIFICATE_FILE, 0),
     "SSL_CTX_use_enc_certificate_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_ENC_PRIVATEKEY, 0),
     "SSL_CTX_use_enc_PrivateKey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_ENC_PRIVATEKEY_FILE, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_SIGN_CERTIFICATE, 0),
     "SSL_CTX_use_sign_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_SIGN_CERTIFICATE_FILE, 0),
     "SSL_CTX_use_sign_certificate_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_SIGN_PRIVATEKEY, 0),
     "SSL_CTX_use_sign_PrivateKey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_SIGN_PRIVATEKEY_FILE, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_DC_TBS_DATA, 0), "ssl_dc_tbs_data"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CERT_IDX, 0), "ssl_set_cert_idx"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CIPHER_LIST, 0),
     "SSL_set_cipher_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CT_VALIDATION_CALLBACK, 0),
     "SSL_set_ct_validation_callback"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_DC, 0), "ssl_set_dc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_DC_PKEY, 0), "ssl_set_dc_pkey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_FD, 0), "SSL_set_fd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_PKEY, 0), "ssl_set_pkey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_PKEY_IDX, 0), "ssl_set_pkey_idx"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_CERTIFICATE_FILE_IDX, 0),
     "ssl_use_certificate_file_idx"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_CERTIFICATE_IDX, 0),
     "ssl_use_certificate_idx"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_DC, 0), "SSL_use_dc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_DC_FILE, 0), "SSL_use_dc_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_DC_PRIVATEKEY, 0),
     "SSL_use_dc_PrivateKey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_DC_PRIVATEKEY_FILE, 0),
     "SSL_use_dc_PrivateKey_file"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_PRIVATEKEY_FILE_IDX, 0),
     "ssl_use_PrivateKey_file_idx"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_PRIVATEKEY_IDX, 0),
     "ssl_use_PrivateKey_idx"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_VERIFY_DELEGATED_CREDENTIAL_SIGNATURE, 0),
     "SSL_verify_delegated_credential_signature"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_STATE_MACHINE_NTLS, 0), "state_machine_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS12_GET_SIGN_HASH_ID, 0),
     "tls12_get_sign_hash_id"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS13_RESTORE_HANDSHAKE_DIGEST_FOR_PHA_NTLS, 0),
     "tls13_restore_handshake_digest_for_pha_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS13_SAVE_HANDSHAKE_DIGEST_FOR_PHA, 0),
     "tls13_save_handshake_digest_for_pha"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS13_SAVE_HANDSHAKE_DIGEST_FOR_PHA_NTLS, 0),
     "tls13_save_handshake_digest_for_pha_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SET_SHARED_DC_SIGALGS, 0),
     "tls1_set_shared_dc_sigalgs"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CLIENT_KEY_EXCHANGE_POST_WORK_NTLS, 0),
     "tls_client_key_exchange_post_work_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_COLLECT_EXTENSIONS, 0),
     "tls_collect_extensions"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_COLLECT_EXTENSIONS_NTLS, 0),
     "tls_collect_extensions_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CERTIFICATE_REQUEST_NTLS, 0),
     "tls_construct_certificate_request_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CERT_STATUS_BODY_NTLS, 0),
     "tls_construct_cert_status_body_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CERT_VERIFY, 0),
     "tls_construct_cert_verify"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CERT_VERIFY_NTLS, 0),
     "tls_construct_cert_verify_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CHANGE_CIPHER_SPEC, 0),
     "tls_construct_change_cipher_spec"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CHANGE_CIPHER_SPEC_NTLS, 0),
     "tls_construct_change_cipher_spec_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CLIENT_CERTIFICATE_NTLS, 0),
     "tls_construct_client_certificate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CLIENT_HELLO, 0),
     "tls_construct_client_hello"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CLIENT_HELLO_NTLS, 0),
     "tls_construct_client_hello_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CLIENT_KEY_EXCHANGE, 0),
     "tls_construct_client_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CLIENT_KEY_EXCHANGE_NTLS, 0),
     "tls_construct_client_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CLIENT_VERIFY, 0), ""},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_COMPRESSED_CERTIFICATE, 0),
     "tls_construct_compressed_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_COMPRESS_CERT, 0),
     "tls_construct_compress_cert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_ALPN, 0),
     "tls_construct_ctos_alpn"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_ALPN_NTLS, 0),
     "tls_construct_ctos_alpn_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_COOKIE_NTLS, 0),
     "tls_construct_ctos_cookie_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_DELEGATED_CREDENTIAL, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_EARLY_DATA_NTLS, 0),
     "tls_construct_ctos_early_data_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_EC_PT_FORMATS, 0),
     "tls_construct_ctos_ec_pt_formats"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_EC_PT_FORMATS_NTLS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_KEY_SHARE_NTLS, 0),
     "tls_construct_ctos_key_share_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_MAXFRAGMENTLEN, 0),
     "tls_construct_ctos_maxfragmentlen"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_MAXFRAGMENTLEN_NTLS, 0),
     "tls_construct_ctos_maxfragmentlen_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_NPN, 0),
     "tls_construct_ctos_npn"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_NPN_NTLS, 0),
     "tls_construct_ctos_npn_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_PADDING, 0),
     "tls_construct_ctos_padding"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_PADDING_NTLS, 0),
     "tls_construct_ctos_padding_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_POST_HANDSHAKE_AUTH, 0),
     "tls_construct_ctos_post_handshake_auth"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_POST_HANDSHAKE_AUTH_NTLS, 0),
     "tls_construct_ctos_post_handshake_auth_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_PSK_KEX_MODES_NTLS, 0),
     "tls_construct_ctos_psk_kex_modes_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_PSK_NTLS, 0),
     "tls_construct_ctos_psk_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_RENEGOTIATE_NTLS, 0),
     "tls_construct_ctos_renegotiate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SCT, 0),
     "tls_construct_ctos_sct"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SCT_NTLS, 0),
     "tls_construct_ctos_sct_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SERVER_NAME, 0),
     "tls_construct_ctos_server_name"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SERVER_NAME_NTLS, 0),
     "tls_construct_ctos_server_name_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SESSION_TICKET, 0),
     "tls_construct_ctos_session_ticket"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SESSION_TICKET_NTLS, 0),
     "tls_construct_ctos_session_ticket_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SIG_ALGS, 0),
     "tls_construct_ctos_sig_algs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SIG_ALGS_NTLS, 0),
     "tls_construct_ctos_sig_algs_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SRP, 0),
     "tls_construct_ctos_srp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SRP_NTLS, 0),
     "tls_construct_ctos_srp_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_STATUS_REQUEST, 0),
     "tls_construct_ctos_status_request"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_STATUS_REQUEST_NTLS, 0),
     "tls_construct_ctos_status_request_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SUPPORTED_GROUPS, 0),
     "tls_construct_ctos_supported_groups"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SUPPORTED_GROUPS_NTLS, 0),
     "tls_construct_ctos_supported_groups_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SUPPORTED_VERSIONS, 0),
     "tls_construct_ctos_supported_versions"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_SUPPORTED_VERSIONS_NTLS, 0),
     "tls_construct_ctos_supported_versions_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_USE_SRTP, 0),
     "tls_construct_ctos_use_srtp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_USE_SRTP_NTLS, 0),
     "tls_construct_ctos_use_srtp_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_VERIFY, 0), ""},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_DELEGATED_CREDENTIAL_RAW, 0),
     "tls_construct_delegated_credential_raw"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_DELEGATED_CREDENTIAL_REQUEST, 0),
     "tls_construct_delegated_credential_request"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_END_OF_EARLY_DATA_NTLS, 0),
     "tls_construct_end_of_early_data_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_EXTENSIONS, 0),
     "tls_construct_extensions"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_EXTENSIONS_NTLS, 0),
     "tls_construct_extensions_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_FINISHED, 0),
     "tls_construct_finished"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_FINISHED_NTLS, 0),
     "tls_construct_finished_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_KEY_UPDATE_NTLS, 0),
     "tls_construct_key_update_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_NEW_SESSION_TICKET, 0),
     "tls_construct_new_session_ticket"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_NEW_SESSION_TICKET_NTLS, 0),
     "tls_construct_new_session_ticket_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_NEXT_PROTO, 0),
     "tls_construct_next_proto"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_NEXT_PROTO_NTLS, 0),
     "tls_construct_next_proto_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_SERVER_CERTIFICATE, 0),
     "tls_construct_server_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_SERVER_CERTIFICATE_NTLS, 0),
     "tls_construct_server_certificate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_SERVER_HELLO, 0),
     "tls_construct_server_hello"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_SERVER_HELLO_NTLS, 0),
     "tls_construct_server_hello_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_SERVER_KEY_EXCHANGE, 0),
     "tls_construct_server_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_SERVER_KEY_EXCHANGE_NTLS, 0),
     "tls_construct_server_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_ALPN, 0),
     "tls_construct_stoc_alpn"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_ALPN_NTLS, 0),
     "tls_construct_stoc_alpn_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_COOKIE_NTLS, 0),
     "tls_construct_stoc_cookie_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_CRYPTOPRO_BUG, 0),
     "tls_construct_stoc_cryptopro_bug"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_CRYPTOPRO_BUG_NTLS, 0),
     "tls_construct_stoc_cryptopro_bug_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_DELEGATED_CREDENTIAL, 0),
     "tls_construct_stoc_delegated_credential"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_EARLY_DATA_NTLS, 0),
     "tls_construct_stoc_early_data_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_EC_PT_FORMATS, 0),
     "tls_construct_stoc_ec_pt_formats"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_EC_PT_FORMATS_NTLS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_KEY_SHARE_NTLS, 0),
     "tls_construct_stoc_key_share_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_MAXFRAGMENTLEN, 0),
     "tls_construct_stoc_maxfragmentlen"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_MAXFRAGMENTLEN_NTLS, 0),
     "tls_construct_stoc_maxfragmentlen_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_NEXT_PROTO_NEG, 0),
     "tls_construct_stoc_next_proto_neg"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_NEXT_PROTO_NEG_NTLS, 0),
     "tls_construct_stoc_next_proto_neg_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_PSK, 0),
     "tls_construct_stoc_psk"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_PSK_NTLS, 0),
     "tls_construct_stoc_psk_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_RENEGOTIATE_NTLS, 0),
     "tls_construct_stoc_renegotiate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SERVER_NAME, 0),
     "tls_construct_stoc_server_name"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SERVER_NAME_NTLS, 0),
     "tls_construct_stoc_server_name_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SESSION_TICKET, 0),
     "tls_construct_stoc_session_ticket"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SESSION_TICKET_NTLS, 0),
     "tls_construct_stoc_session_ticket_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_STATUS_REQUEST, 0),
     "tls_construct_stoc_status_request"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_STATUS_REQUEST_NTLS, 0),
     "tls_construct_stoc_status_request_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SUPPORTED_GROUPS, 0),
     "tls_construct_stoc_supported_groups"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SUPPORTED_GROUPS_NTLS, 0),
     "tls_construct_stoc_supported_groups_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SUPPORTED_VERSIONS, 0),
     "tls_construct_stoc_supported_versions"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_SUPPORTED_VERSIONS_NTLS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_USE_SRTP_NTLS, 0),
     "tls_construct_stoc_use_srtp_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_DETERMINE_IF_USE_DC_FROM_EXTENSION, 0),
     "tls_determine_if_use_dc_from_extension"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_FINISH_HANDSHAKE_NTLS, 0),
     "tls_finish_handshake_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_GET_MESSAGE_HEADER_NTLS, 0),
     "tls_get_message_header_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_HANDLE_ALPN, 0), "tls_handle_alpn"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_HANDLE_ALPN_NTLS, 0),
     "tls_handle_alpn_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_COMPRESS_CERT, 0),
     "tls_parse_compress_cert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_ALPN, 0),
     "tls_parse_ctos_alpn"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_ALPN_NTLS, 0),
     "tls_parse_ctos_alpn_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_COOKIE, 0),
     "tls_parse_ctos_cookie"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_COOKIE_NTLS, 0),
     "tls_parse_ctos_cookie_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_DELEGATED_CREDENTIAL, 0),
     "tls_parse_ctos_delegated_credential"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_EARLY_DATA, 0),
     "tls_parse_ctos_early_data"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_EARLY_DATA_NTLS, 0),
     "tls_parse_ctos_early_data_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_EC_PT_FORMATS, 0),
     "tls_parse_ctos_ec_pt_formats"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_EC_PT_FORMATS_NTLS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_KEY_SHARE_NTLS, 0),
     "tls_parse_ctos_key_share_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_MAXFRAGMENTLEN, 0),
     "tls_parse_ctos_maxfragmentlen"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_MAXFRAGMENTLEN_NTLS, 0),
     "tls_parse_ctos_maxfragmentlen_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_POST_HANDSHAKE_AUTH, 0),
     "tls_parse_ctos_post_handshake_auth"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_POST_HANDSHAKE_AUTH_NTLS, 0),
     "tls_parse_ctos_post_handshake_auth_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_PSK_KEX_MODES_NTLS, 0),
     "tls_parse_ctos_psk_kex_modes_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_PSK_NTLS, 0),
     "tls_parse_ctos_psk_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_RENEGOTIATE_NTLS, 0),
     "tls_parse_ctos_renegotiate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SERVER_NAME, 0),
     "tls_parse_ctos_server_name"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SERVER_NAME_NTLS, 0),
     "tls_parse_ctos_server_name_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SESSION_TICKET, 0),
     "tls_parse_ctos_session_ticket"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SESSION_TICKET_NTLS, 0),
     "tls_parse_ctos_session_ticket_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SIG_ALGS_CERT_NTLS, 0),
     "tls_parse_ctos_sig_algs_cert_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SIG_ALGS_NTLS, 0),
     "tls_parse_ctos_sig_algs_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SRP, 0), "tls_parse_ctos_srp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SRP_NTLS, 0),
     "tls_parse_ctos_srp_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_STATUS_REQUEST, 0),
     "tls_parse_ctos_status_request"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_STATUS_REQUEST_NTLS, 0),
     "tls_parse_ctos_status_request_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SUPPORTED_GROUPS, 0),
     "tls_parse_ctos_supported_groups"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_SUPPORTED_GROUPS_NTLS, 0),
     "tls_parse_ctos_supported_groups_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_USE_SRTP, 0),
     "tls_parse_ctos_use_srtp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_USE_SRTP_NTLS, 0),
     "tls_parse_ctos_use_srtp_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_DC_FROM_EXTENSION, 0),
     "tls_parse_dc_from_extension"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_ALPN, 0),
     "tls_parse_stoc_alpn"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_ALPN_NTLS, 0),
     "tls_parse_stoc_alpn_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_COOKIE, 0),
     "tls_parse_stoc_cookie"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_COOKIE_NTLS, 0),
     "tls_parse_stoc_cookie_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_DELEGATED_CREDENTIAL, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_EARLY_DATA_NTLS, 0),
     "tls_parse_stoc_early_data_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_RENEGOTIATE_NTLS, 0),
     "tls_parse_stoc_renegotiate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SCT, 0), "tls_parse_stoc_sct"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SCT_NTLS, 0),
     "tls_parse_stoc_sct_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SERVER_NAME, 0),
     "tls_parse_stoc_server_name"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SERVER_NAME_NTLS, 0),
     "tls_parse_stoc_server_name_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SESSION_TICKET, 0),
     "tls_parse_stoc_session_ticket"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SESSION_TICKET_NTLS, 0),
     "tls_parse_stoc_session_ticket_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_STATUS_REQUEST, 0),
     "tls_parse_stoc_status_request"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_STATUS_REQUEST_NTLS, 0),
     "tls_parse_stoc_status_request_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SUPPORTED_VERSIONS, 0),
     "tls_parse_stoc_supported_versions"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_SUPPORTED_VERSIONS_NTLS, 0),
     "tls_parse_stoc_supported_versions_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_USE_SRTP, 0),
     "tls_parse_stoc_use_srtp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_USE_SRTP_NTLS, 0),
     "tls_parse_stoc_use_srtp_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_POST_PROCESS_CLIENT_HELLO, 0),
     "tls_post_process_client_hello"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_POST_PROCESS_CLIENT_HELLO_NTLS, 0),
     "tls_post_process_client_hello_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_POST_PROCESS_CLIENT_KEY_EXCHANGE, 0),
     "tls_post_process_client_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_POST_PROCESS_CLIENT_KEY_EXCHANGE_NTLS, 0),
     "tls_post_process_client_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PREPARE_CLIENT_CERTIFICATE, 0),
     "tls_prepare_client_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PREPARE_CLIENT_CERTIFICATE_NTLS, 0),
     "tls_prepare_client_certificate_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CERTIFICATE_REQUEST_NTLS, 0),
     "tls_process_certificate_request_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CERT_STATUS_BODY_NTLS, 0),
     "tls_process_cert_status_body_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CERT_VERIFY, 0),
     "tls_process_cert_verify"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CERT_VERIFY_NTLS, 0),
     "tls_process_cert_verify_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CHANGE_CIPHER_SPEC, 0),
     "tls_process_change_cipher_spec"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CHANGE_CIPHER_SPEC_NTLS, 0),
     "tls_process_change_cipher_spec_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CLIENT_CERTIFICATE_NTLS, 0),
     "tls_process_client_certificate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CLIENT_HELLO, 0),
     "tls_process_client_hello"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CLIENT_HELLO_NTLS, 0),
     "tls_process_client_hello_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CLIENT_KEY_EXCHANGE, 0),
     "tls_process_client_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CLIENT_KEY_EXCHANGE_NTLS, 0),
     "tls_process_client_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_COMPRESSED_CERTIFICATE, 0),
     "tls_process_compressed_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_DC_REQUEST, 0),
     "tls_process_dc_request"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_END_OF_EARLY_DATA_NTLS, 0),
     "tls_process_end_of_early_data_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_FINISHED, 0),
     "tls_process_finished"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_FINISHED_NTLS, 0),
     "tls_process_finished_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_HELLO_REQ, 0),
     "tls_process_hello_req"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_HELLO_REQ_NTLS, 0),
     "tls_process_hello_req_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_INITIAL_SERVER_FLIGHT_NTLS, 0),
     "tls_process_initial_server_flight_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_KEY_EXCHANGE, 0),
     "tls_process_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_KEY_EXCHANGE_NTLS, 0),
     "tls_process_key_exchange_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_KEY_UPDATE, 0),
     "tls_process_key_update"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_KEY_UPDATE_NTLS, 0),
     "tls_process_key_update_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_NEW_SESSION_TICKET, 0),
     "tls_process_new_session_ticket"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_NEW_SESSION_TICKET_NTLS, 0),
     "tls_process_new_session_ticket_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_NEXT_PROTO, 0),
     "tls_process_next_proto"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_NEXT_PROTO_NTLS, 0),
     "tls_process_next_proto_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SERVER_CERTIFICATE, 0),
     "tls_process_server_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SERVER_CERTIFICATE_NTLS, 0),
     "tls_process_server_certificate_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SERVER_DONE, 0),
     "tls_process_server_done"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SERVER_DONE_NTLS, 0),
     "tls_process_server_done_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SERVER_HELLO, 0),
     "tls_process_server_hello"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SERVER_HELLO_NTLS, 0),
     "tls_process_server_hello_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PSK_DO_BINDER_NTLS, 0),
     "tls_psk_do_binder_ntls"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_SCAN_CLIENTHELLO_TLSEXT, 0), ""},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_SETUP_HANDSHAKE, 0),
     "tls_setup_handshake"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_SETUP_HANDSHAKE_NTLS, 0),
     "tls_setup_handshake_ntls"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_WRITE_STATE_MACHINE, 0),
     "write_state_machine"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_WRITE_STATE_MACHINE_NTLS, 0),
     "write_state_machine_ntls"},
    {0, NULL}
};
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_SM2_ENCRYPT), "bad sm2 encrypt"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_CERT_CB2_ERROR), "cert cb2 error"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DC_LOAD_FAILED),
    "failed to load delegated credential"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DC_VALID_TIME_TOO_LARGE),
    "DC valid time too large"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_EE_CERT_NOT_FOUND), "ee cert not found"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_FAILED_TO_VERIFY_DC_SIGNATURE),
    "failed to verify dc signature"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_FRAGMENTED_CLIENT_HELLO),
    "fragmented client hello"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_GET_SIG_AND_HASH_ERR),
    "unable to get sig and hash"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_LENGTH_LONG), "length long"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_SM2_ENC_CERTIFICATE),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NULL_SSL_CTX_PASSED),
    "null ssl ctx passed"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PARAM_NULL_PKEY), "param null pkey"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PRIVATE_KEY_DOES_NOT_MATCH_DC),
    "private key does not match dc"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_LOOKUP_CERT),
    "unable to lookup cert"},
