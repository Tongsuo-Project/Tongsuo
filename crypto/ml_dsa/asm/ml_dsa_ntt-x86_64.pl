...
###############################################################################
# ML-DSA AVX2 NTT / INTT and NTT-domain polynomial multiply
#
# Implemented:
...
my $ML_DSA_Q_INV = 58728449;        # Q^{-1} mod 2^32
...
# Broadcast Q^{-1} and Q (eight int32 lanes each) for ml_dsa_poly-x86_64.pl
.align 64
.globl  qdata
.type   qdata,\@object
qdata:
    .long $ML_DSA_Q_INV, $ML_DSA_Q_INV, $ML_DSA_Q_INV, $ML_DSA_Q_INV, $ML_DSA_Q_INV, $ML_DSA_Q_INV, $ML_DSA_Q_INV, $ML_DSA_Q_INV
    .long $ML_DSA_Q, $ML_DSA_Q, $ML_DSA_Q, $ML_DSA_Q, $ML_DSA_Q, $ML_DSA_Q, $ML_DSA_Q, $ML_DSA_Q
.size   qdata, .-qdata
