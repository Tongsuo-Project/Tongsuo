...
static int wbsm4_xiaolai_gcm_ctrl(EVP_CIPHER_CTX *c, int type, int arg, void *ptr);
...
static int wbsm4_xiaolai_ccm_ctrl(EVP_CIPHER_CTX *c, int type, int arg, void *ptr);
