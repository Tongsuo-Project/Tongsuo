...
DECLARE_STATIC_ASN1_ALLOC_FUNCTIONS(X9_62_PENTANOMIAL)
IMPLEMENT_STATIC_ASN1_ALLOC_FUNCTIONS(X9_62_PENTANOMIAL)
...
DECLARE_STATIC_ASN1_ALLOC_FUNCTIONS(X9_62_CHARACTERISTIC_TWO)
IMPLEMENT_STATIC_ASN1_ALLOC_FUNCTIONS(X9_62_CHARACTERISTIC_TWO)
...
IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(ECPKPARAMETERS)
IMPLEMENT_ASN1_ALLOC_FUNCTIONS_fname(ECPKPARAMETERS, ECPKPARAMETERS, ECPKPARAMETERS)
...
DECLARE_STATIC_ASN1_FUNCTIONS_const(EC_PRIVATEKEY)
DECLARE_STATIC_ASN1_ENCODE_FUNCTIONS_const(EC_PRIVATEKEY, EC_PRIVATEKEY)
IMPLEMENT_STATIC_ASN1_FUNCTIONS_const(EC_PRIVATEKEY)
...
static int ec_asn1_group2fieldid(const EC_GROUP *group, X9_62_FIELDID *field)
{
 ...
 err:
    ...
    X9_62_PENTANOMIAL_free(NULL);
    X9_62_CHARACTERISTIC_TWO_free(NULL);
    BN_free(tmp);
    return ok;
}
