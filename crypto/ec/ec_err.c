...
static const ERR_STRING_DATA EC_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_SET_ENGINE, 0), "EC_GROUP_set_engine"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_COPY, 0), "EC_POINTS_copy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_FROM_STRINGS, 0),
     "EC_POINTs_from_strings"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_FROM_STRINGS_SCALAR_MUL, 0),
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_NEW, 0), "EC_POINTS_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_SCALARS_MUL, 0),
     "EC_POINTs_scalars_mul"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_SCALAR_MUL, 0),
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_METHOD_COPY, 0),
     "EC_POINT_METHOD_copy"},
