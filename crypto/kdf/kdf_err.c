...
static const ERR_STRING_DATA KDF_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_KDF, KDF_F_KRB5KDF_CTRL_STR, 0), "krb5kdf_ctrl_str"},
    {ERR_PACK(ERR_LIB_KDF, KDF_F_KRB5KDF_DERIVE, 0), "krb5kdf_derive"},
    {ERR_PACK(ERR_LIB_KDF, KDF_F_KRB5KDF_NEW, 0), "krb5kdf_new"},
...
static const ERR_STRING_DATA KDF_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_KDF, 0, KDF_R_INVALID_CONSTANT_LENGTH),
    "invalid constant length"},
    {ERR_PACK(ERR_LIB_KDF, 0, KDF_R_INVALID_DIGEST), "invalid digest"},
    {ERR_PACK(ERR_LIB_KDF, 0, KDF_R_INVALID_SEED_LENGTH),
    "invalid seed length"},
