...
static const ERR_STRING_DATA ENGINE_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ECPMETH_GET_DATA_CTX, 0),
     "ecpmeth_get_data_ctx"},
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ECPMETH_SET_DATA_CTX, 0),
     "ecpmeth_set_data_ctx"},
    ...
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_GET_DIGEST, 0),
     "ENGINE_get_digest"},
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_GET_ECP_METH, 0),
     "ENGINE_get_ecp_meth"},
...
static const ERR_STRING_DATA ENGINE_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_ENGINE, 0, ENGINE_R_UNIMPLEMENTED_ECP_METH),
    "unimplemented ecp meth"},
