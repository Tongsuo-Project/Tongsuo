...
ENGINE_get_digest_engine, ENGINE_get_ecp_meth_engine, ENGINE_get_first,
ENGINE_get_last, ENGINE_get_next, ENGINE_get_prev, ENGINE_new,
ENGINE_get_ciphers, ENGINE_get_ctrl_function,
ENGINE_get_digests, ENGINE_get_ecp_meths,
...
ENGINE_get_digest, ENGINE_get_ecp_meth, ENGINE_add, ENGINE_cmd_is_executable,
...
ENGINE_register_complete, ENGINE_register_digests, ENGINE_register_ecp_meths,
ENGINE_remove, ENGINE_set_DH, ENGINE_set_DSA,
...
ENGINE_register_all_ecp_meths,
ENGINE_set_table_flags, ENGINE_unregister_DH,
ENGINE_unregister_DSA,
ENGINE_unregister_RAND, ENGINE_unregister_RSA, ENGINE_unregister_ciphers,
ENGINE_unregister_digests,
ENGINE_unregister_ecp_meths
...
=head1 SYNOPSIS
 ...
 ENGINE *ENGINE_get_ecp_meth_engine(int nid);
 ...
 int ENGINE_register_all_ecp_meths(void);
 ...
 ENGINE_ECP_METHS_PTR ENGINE_get_ecp_meths(const ENGINE *e);
...
implementation includes the following abstractions;
 ...
 EC_POINT_METHOD - for providing alternative EC_POINT implementations
                   (indexed by 'nid')
...
All ENGINE_get_default_TYPE() functions, ENGINE_get_cipher_engine(),
ENGINE_get_digest_engine() and ENGINE_get_ecp_meth_engine() return a valid
...
ENGINE_get_ciphers(), ENGINE_get_digests() and ENGINE_get_ecp_meths() return
...
ENGINE_get_ecp_meth() returns a valid B<EC_POINT_METHOD> structure on success
