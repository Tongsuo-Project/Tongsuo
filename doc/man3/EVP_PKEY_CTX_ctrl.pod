...
and I<p2> is the MAC key. This is used by Poly1305, EIA3, SipHash, HMAC and CMAC.

For B<cmd> = B<EVP_PKEY_CTRL_SET_IV>, B<p1> is the length of the MAC iv,
and B<p2> is MAC iv. This is used by EIA3.
