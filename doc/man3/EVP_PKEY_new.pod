...
B<EVP_PKEY_EIA3>, B<EVP_PKEY_SIPHASH>, B<EVP_PKEY_HMAC> are also accepted.
This usage is, as mentioned above, discouraged in favor of the L<EVP_MAC(3)>
API.
...
Currently this is: B<EVP_PKEY_HMAC>, B<EVP_PKEY_POLY1305>, B<EVP_PKEY_EIA3>,
B<EVP_PKEY_SIPHASH>, B<EVP_PKEY_X25519>, B<EVP_PKEY_ED25519>, B<EVP_PKEY_X448>
or B<EVP_PKEY_ED448>.
