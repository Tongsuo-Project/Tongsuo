...
# define IMPLEMENT_ASN1_ENCODE_FUNCTIONS_pfname(pre, stname, itname, fname) \
        ...
        pre int i2d_##fname(const stname *a, unsigned char **out) \
        { \
                return ASN1_item_i2d((const ASN1_VALUE *)a, out, ASN1_ITEM_rptr(itname));\
        }
...
# define IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS_fname(stname, itname, fname) \
        IMPLEMENT_ASN1_ENCODE_FUNCTIONS_pfname(static, stname, itname, fname)
