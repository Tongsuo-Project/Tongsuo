...
/*
 * Internal tests for the rand self test
 */
...
#include "rand_self_test.h"

static int TEST_double_eq(double a, double b)
{
 ...
 */
static int test_rand_self_test(void)
{
    int ret = 0;
