...
static int test_wbsm4_standard(void)
{
    ...
    TEST_info("Begin test_wbsm4_standard");

    wbsm4_gen(key,wb,&whitebox_len);
    TEST_info("Function: wbsm4_gen, return length of wb");

    wb = OPENSSL_malloc(whitebox_len);
    TEST_info("Malloc space for wb");
    
    wbsm4_gen(key,wb,&whitebox_len);
    TEST_info("Function: wbsm4_gen, gen wb");

    memcpy(block, input, 16);

    wbsm4_encrypt(block, block, wb);
    TEST_info("Function: wbsm4_encrypt, encryption done");
    ...
    TEST_info("Function: wbsm4_decrypt, decryption done");
    ...
    OPENSSL_free(wb);
    TEST_info("Finish test_wbsm4_standard");
    return 1;
}
...
static int test_wbsm4_random_gen_tables(void){
    ...
    TEST_info("Begin test_wbsm4_random_gen_tables");
    wbsm4_gen(key,wb1,&whitebox_len1);
    TEST_info("Function: wbsm4_gen 1, return length of wb1");
    wb1 = OPENSSL_malloc(whitebox_len1);
    TEST_info("Malloc space for wb1");
    wbsm4_gen(key,wb2,&whitebox_len2);
    TEST_info("Function: wbsm4_gen 2, return length of wb2");
    wb2 = OPENSSL_malloc(whitebox_len2);
    TEST_info("Malloc space for wb2");

    wbsm4_gen(key,wb1,&whitebox_len1);
    TEST_info("Function: wbsm4_gen, gen wb1");
    wbsm4_gen(key,wb2,&whitebox_len2);
    TEST_info("Function: wbsm4_gen, gen wb2");
    ...
    OPENSSL_free(wb1);
    OPENSSL_free(wb2);
    TEST_info("Finish test_wbsm4_random_gen_tables");
    return 1;
}
...
static int test_wbsm4_random_key_and_input(void){
    ...
    TEST_info("Begin test_wbsm4_random_key_and_input");
    ossl_sm4_set_key(k, &key);
    TEST_info("Standard SM4 set key");
    ...
    TEST_info("Standard SM4 encryption");
    ...
    TEST_info("Standard SM4 decryption");
    ...
    OPENSSL_free(wb);
    TEST_info("Finish test_wbsm4_random_key_and_input");
    return 1;
}
#endif
